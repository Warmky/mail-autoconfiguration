...
import csv
'''
通过前面生成的redirects_statistics_autodiscover_320.json(不包含preself前缀)，生成了small_providers_320_autodiscover.csv，看看那些small_provider具体是哪些，以及其提供服务的域名里是否包含自己
'''
# 读取 JSON 文件
with open("redirects_statistics_autodiscover_320.json", "r", encoding="utf-8") as f:
...
# 写入 CSV 文件
output_file = "small_providers_320_autodiscover.csv"
