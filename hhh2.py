...
for provider, customers in redirect_stats.items():
    ...
    is_small_provider = total_customers < 50 #10
...
df.to_csv("redirects_tld_statistics_autodiscover_320.csv", index=False, encoding="utf-8")

print("新CSV文件已生成：redirects_tld_statistics_autodiscover_320.csv")
