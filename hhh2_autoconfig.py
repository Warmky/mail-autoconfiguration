...
with open("redirects_statistics_320_autoconfig.json", "r", encoding="utf-8") as f:
...
df.to_csv("redirects_tld_statistics_320_autoconfig.csv", index=False, encoding="utf-8")
